  ...
  return (
    <div>
        ...
        <form
            ...
            className="flex w-full gap-2 mt-6 items-center justify-center"
        >
            <textarea
            name=""
            id=""
        ...
        <div className=" pt-5">
            {
                messages.map((chat) => (
                    <div className={`bg-gray-700/80 flex gap-12 p-3 mt-2 mb-3 text-white font-sans rounded-md ${chat.isAdminChat?"flex":"flex-row-reverse"}`} key={chat._id}>
